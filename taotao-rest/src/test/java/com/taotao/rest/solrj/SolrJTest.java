...
//	private final static String SOLR_URL = "http://192.168.2.128:8080/solr";
// final String solrname="solrcore";
//
...
//     inputDocument.addField("item_title", "角色名称");
//     // 执行添加 ps：如果id相同，则执行更新操作
//     // 要指定操作的collection 就是solr-home下定义的core
//     UpdateResponse add = solrClient.add("solrcore", inputDocument);
//     //提交添加/更新
...
//     solrClient.deleteById("solrcore", "test001");
//     // 还可以通过查询条件删除
...
//     QueryResponse response = solrClient.query("solrcore", mapSolrParams);
//     // 获取结果集
